...
//TO:DO
/*
* Test that the location pup-up bubble appears as expected on hover
*/
...
describe("User", () => {
    ...
    it("navigates to Schedule/My Courses", async () => {
      
      let button1 = driver.findElement(By.partialLinkText('Schedule'));
      //await driver.findElement(By.className("ml-3 m-lg-0"));
      await button1.click();
      let button2 = await driver.findElement(By.xpath('//*[@id="m_header_menu"]/ul/li[2]/div/ul/li[1]/a/span'));
      await button2.click();

      await expect(await driver.getTitle()).toBe('My Courses | UNIC Portal');
    }, 50000);

    //Clicks on a course
    it("clicks on a course", async () => {

      let courseButton = await driver.findElement(By.xpath('//*[@id="courseScheduleDT"]/tbody/tr[3]/td[1]/a'));
    ...
    it("clicks on a professor", async () => {
      ...
      //Go back
      await driver.get("https://portal.unic.ac.cy/schedule/courses?academic-period-id=454");
    ...
    it("changes period to Spring 2018", async () => {
      ...
      let periodButton = await driver.findElement(By.xpath('//*[@id="bs-select-1-4"]/span[2]'));
      await periodButton.click();

      await expect(await driver.getCurrentUrl()).toBe('https://portal.unic.ac.cy/schedule/courses?academic-period-id=427');
