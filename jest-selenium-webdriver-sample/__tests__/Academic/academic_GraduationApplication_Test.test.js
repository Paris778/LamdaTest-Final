...
/*
* 
* For a different testing account there would be lots of things to test
*
*/
...
describe("User", () => {
    ...
    it("navigates to Academic/Graduation Application", async () => {
    
      let button1 = driver.findElement(By.partialLinkText('Academic'));
      await button1.click();
      let button2 = await driver.findElement(By.xpath("/html/body/div[1]/header/div[2]/div/div/div/div/ul/li[3]/div/ul/li[6]/a/span"));
      await button2.click();
  
      await expect(await driver.getTitle()).toBe('Graduation Application | UNIC Portal');
    }, 50000);
