...
//TO:DO
/*
* This page was empty for this account.
* There are definitely things to test for, for different users.
*
*/
...
describe("User", () => {
    ...
    it("navigates to Academic/Second Exam", async () => {
    
      let button1 = driver.findElement(By.partialLinkText('Academic'));
      await button1.click();
      let button2 = await driver.findElement(By.xpath("/html/body/div[1]/header/div[2]/div/div/div/div/ul/li[3]/div/ul/li[10]/a/span"));
      await button2.click();
  
      await expect(await driver.getTitle()).toBe('Second Exam | UNIC Portal');
    }, 50000);
