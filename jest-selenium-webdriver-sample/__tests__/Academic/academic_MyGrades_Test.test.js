...
//TO:DO
/*
* Test that all the hover pop ups work as expected 
* Test that when you click on a grade the little window pops up as expected
* Test the behaviour of the GPA Performance element
* Test the bahaviour of the Grade Distribution Element
*/
...
describe("User", () => {
    ...
    it("navigates to Academic/My Grades", async () => {
    
      let button1 = driver.findElement(By.partialLinkText('Academic'));
      await button1.click();
      let button2 = await driver.findElement(By.xpath("/html/body/div[1]/header/div[2]/div/div/div/div/ul/li[3]/div/ul/li[1]/a/span"));
      await button2.click();
  
      await expect(await driver.getTitle()).toBe('My Grades | UNIC Portal');
    }, 50000);
