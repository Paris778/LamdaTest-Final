...
describe("User", () => {
    ...
    it("navigates to Academic/Library", async () => {
    
      let button1 = driver.findElement(By.partialLinkText('Academic'));
      await button1.click();
      let button2 = await driver.findElement(By.xpath('//*[@id="m_header_menu"]/ul/li[3]/div/ul/li[8]/a'));
      await button2.click();
      ...
      await expect(await driver.getTitle()).toBe('University of Nicosia Library | UNIC Library');
    }, 50000);
